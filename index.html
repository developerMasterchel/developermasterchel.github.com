...
<link rel="stylesheet" href="./index_files/common.47b4b69c.css" "="" />
<link rel="stylesheet" href="./index_files/message.9cfdd4ac.css" "="" />
<link rel="stylesheet" href="./index_files/page.resume_view.b6cc192e.css" "="">
</head>
<body id="resume-view">
...
<div class="wrap view-wrap">
  <div class="view-main ">
  		...
  		<div class="card-main">
  			...
  			<ul class="list clearfix">
  				...
  				<li>
  					...
  					<p class="list-main" title="java软件工程师">java软件工程师</p>
  				</li>
  				<li>
  					<span class="list-title">工作年限：</span>
  					<p class="list-main">3年</p>
  				</li>
  			</ul>
  		</div>
  	</div>
	...
	<div class="view-content">
		...
		<a target="_blank" href="https://gitee.com/Chariesliven/projects">https://gitee.com/Chariesliven/projects</a>
	</div>
	...
	<div class="view-content">
        ...
        <p class="view-area">具有良好的英文阅读理解能力；<br>有安全编码的项目基础。<br>JAVA基础扎实，理解io、多线程、集合 等基础。<br>熟悉redis （热点数据）、zookeeper。<br>熟练spring-mvc spring-boot、ssm框架的基础。<br>熟练的数据库操作  MySQL、熟悉oracle的使用,以及sql调优。<br>熟练的JVM虚拟机资源消耗调优.</p>
    </div>
